...
public:
	...
	image_region_read_plan(const image_region_read_plan &other) = delete;
	image_region_read_plan(image_region_read_plan &&other) noexcept = default;
	~image_region_read_plan() = default;

	image_region_read_plan&
	operator=(const image_region_read_plan &other) = delete;
	image_region_read_plan&
	operator=(image_region_read_plan &&other) noexcept = default;
